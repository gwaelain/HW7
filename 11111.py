...
some_student = Student('Paul', 'Rikman', 'male')
student_1 = Student('Vigo', 'Mortin', 'male')
...
some_reviewer = Reviewer('Anna', 'Bole')
reviewer_1 = Reviewer('Serg', 'Dement')
...
some_lecturer = Lecturer('Ahill', 'Whist')
lecturer_1 = Lecturer('Oliver', 'Crown')
